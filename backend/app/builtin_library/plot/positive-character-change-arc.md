...
template:
  ...
  - id: local_writing_app_generic
    ...
    url: null
    citation: ''
    note: Generic structure guidance authored for the app, not imported from a protected
      beat sheet.
    metadata: {}
  ip_risk: low
  ...
  metadata: {}
metadata:
  genre: Any — a character growth arc that overlays any genre or external plot structure.
  beats:
  - title: Want and lie
