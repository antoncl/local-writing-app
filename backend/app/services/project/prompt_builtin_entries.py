...
<plot_suggestions>
  <suggestion kind="card_revision|beat_revision|claim_change|new_card|new_claim|question" target_card_id="card_id_if_known" target_claim_id="claim_id_if_known" template_instance_id="template_instance_id_if_known" plot_point_id="plot_point_id_if_known">
    ...
    <open_question>For beat_revision or question: one concrete unresolved author decision.</open_question>
