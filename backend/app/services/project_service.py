...
class ProjectService(ChatSessionsMixin, PromptEntriesMixin, LoreEntriesMixin):
    ...
    # ChatSessionsMixin (services/project/chats.py); `compute_project_cost`
    # and `_utcnow_iso` stay here because they're cost-surface / generic
    # utilities the ai_invocations writer also uses.
