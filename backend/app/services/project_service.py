...
# `NodeIndex` is still used in core type hints (the metadata-value
# validators); the index-building + reference resolution itself lives in
# ReferencesMixin (project/references.py).
