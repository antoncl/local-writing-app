...
- Status: **Proposed** — awaiting Anton's review (revision 2, after his round-one mockup feedback: tri-state confirmed; presets confusing → retired; tags/views drillable; plot integrated).
...
- Review mockup: "Context Picker, Take Two", rev 2 (interactive artifact; not normative — the decisions below are).
