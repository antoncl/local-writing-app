...
- Status: **Accepted** — 2026-09-16, Anton Lauridsen, PR #1980 (authored by Claude). Answers the deferred non-goal of ADR-0043. This is the **model** ADR; the combined-scrubber **surface** is a companion ADR (ADR-0088), as ADR-0044 followed ADR-0043.
