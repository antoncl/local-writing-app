...
<script lang="ts">
  ...
  function updateEntryInputNodePickerConfig(
    index: number,
    config: import("@/lib/types").NodePickerConfig,
  ): void {
        ...
        {#if isExpanded}
          <div class="schema-field-inline prompt-input-inline">
            <div class="prompt-input-grid">
              ...
              <label>
                Type
                <select value={draft.type} onchange={(e) => updateEntryInput(index, { type: (e.currentTarget as HTMLSelectElement).value as import("@/lib/types").PromptInputType, defaultValue: undefined })}>
