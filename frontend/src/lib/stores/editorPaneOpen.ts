...
import { revealOnPlotBoard } from "@/lib/stores/plotlines";
...
export interface PaneOpenHost {
  ...
  openPlotTemplate(id: string): Promise<void>;
...
// `plotline` backlink still REVEALS on the board (revealOnPlotBoard), not here.
