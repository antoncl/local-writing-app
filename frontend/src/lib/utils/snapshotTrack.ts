...
//
// Known ambiguity, stated so it is not later mistaken for a defect: under
// keep-five thinning a gap can mean "a week passed" or "a snapshot used to be
// there". A lone explicit notch far left is "the oldest thing I chose to keep",
// not "the oldest thing that existed".
//
...
/**
 * Notch positions for `agesMinutes` — **oldest first**, matching the listing
 * order — as percentages of the track.
 *
