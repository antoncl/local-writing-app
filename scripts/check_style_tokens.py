...
GRANDFATHERED = {
    ...
    "frontend/src/components/editor/body/MutationAuthoringForm.svelte",
    "frontend/src/components/editor/body/MutationCloseForm.svelte",
    "frontend/src/components/editor/body/MutationDialogShell.svelte",
    "frontend/src/components/editor/body/MutationFieldRows.svelte",
    "frontend/src/components/editor/body/MutationSetEditor.svelte",
    "frontend/src/components/editor/body/PromptPreviewPane.svelte",
    "frontend/src/components/editor/body/ProseAIToolbar.svelte",
    "frontend/src/components/editor/body/ProseSelectionToolbar.svelte",
    "frontend/src/components/editor/body/ProseSlashMenu.svelte",
    "frontend/src/components/editor/body/ProseTableToolbar.svelte",
    "frontend/src/components/editor/body/ViewBodyView.svelte",
    "frontend/src/components/editor/body/chat/ChatInputsStrip.svelte",
    "frontend/src/components/editor/body/chat/ChatJournalScope.svelte",
    "frontend/src/components/editor/body/chat/ChatTranscript.svelte",
    "frontend/src/components/editor/body/view/ViewFlowNode.svelte",
    "frontend/src/components/editor/body/view/ViewGlyph.svelte",
    ...
    "frontend/src/components/widgets/ColoredSelect.svelte",
    "frontend/src/components/widgets/CountPill.svelte",
    "frontend/src/components/widgets/FieldValueEditor.svelte",
    "frontend/src/components/widgets/GroupCaret.svelte",
    "frontend/src/components/widgets/IconPicker.svelte",
    "frontend/src/components/widgets/MetadataLongTextEditor.svelte",
    "frontend/src/components/widgets/NodePicker.svelte",
    "frontend/src/components/widgets/NodeRow.svelte",
    "frontend/src/components/widgets/PlainTextEditor.svelte",
    "frontend/src/components/widgets/ProviderTierPicker.svelte",
    "frontend/src/components/widgets/ReferencePicker.svelte",
    "frontend/src/components/widgets/SearchInput.svelte",
    "frontend/src/components/widgets/SwatchPicker.svelte",
    "frontend/src/components/widgets/TagPicker.svelte",
    "frontend/src/components/widgets/ViewSwitcher.svelte",
